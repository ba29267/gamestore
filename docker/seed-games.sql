...
-- 100+ games for comprehensive testing & Users
-- Execute this SQL after database initialization

-- ============================================================================
-- SEED USERS (Admin & Test Accounts)
-- ============================================================================
-- Note: Passwords should be bcrypt hashed in production
-- For testing, insert users after table creation
-- Default test users:
--   Admin: admin / admin
--   User1: user / user123
--   User2: user2 / user456
...
-- Insert Admin User
-- Password: admin
-- Hash: bcrypt('admin', 10)
INSERT INTO users (username, email, password, role, created_at, updated_at) VALUES
('admin', 'admin@gamestore.local', '$2b$10$slYQmyNdGzin7olVeolvFODlH8Oy3w8xZpKzQIjlMrqpEWZZIu9/q', 'ADMIN', NOW(), NOW()),

-- Insert Test Users (all with password: admin)
('john_doe', 'john@example.com', '$2b$10$slYQmyNdGzin7olVeolvFODlH8Oy3w8xZpKzQIjlMrqpEWZZIu9/q', 'USER', NOW(), NOW()),
('jane_smith', 'jane@example.com', '$2b$10$slYQmyNdGzin7olVeolvFODlH8Oy3w8xZpKzQIjlMrqpEWZZIu9/q', 'USER', NOW(), NOW()),
('test_user', 'test@example.com', '$2b$10$slYQmyNdGzin7olVeolvFODlH8Oy3w8xZpKzQIjlMrqpEWZZIu9/q', 'USER', NOW(), NOW());
...
-- Insert games data with diverse genres, platforms, and pricing
...
-- More Fighting Games
('Guilty Gear Strive', 'Anime fighting. High-octane battles with stunning visuals and complex mechanics.', 'Fighting', 'PS5', 59.99, 4.7, '2021-06-18', NOW(), NOW()),
('BlazBlue: Cross Tag Battle', 'Crossover fighting. Iconic characters from multiple franchises clash.', 'Fighting', 'Nintendo Switch', 39.99, 4.4, '2018-06-05', NOW(), NOW()),

-- More Adventure Games
('Beyond: Two Souls', 'Supernatural journey. Navigate a paranormal mystery with branching choices.', 'Adventure', 'PS4', 29.99, 4.5, '2013-10-08', NOW(), NOW()),
('Heavy Rain', 'Interactive drama. Four characters'' fates intertwine in this emotional thriller.', 'Adventure', 'PS4', 19.99, 4.4, '2010-02-23', NOW(), NOW()),

-- More Shooter Games
('The Division 2', 'Post-apocalyptic shooter. Reclaim Washington DC in this looter shooter.', 'Shooter', 'PC', 29.99, 4.3, '2019-03-15', NOW(), NOW()),
('Rainbow Six Siege', 'Tactical team shooter. Breach, clear, and solve with your squad.', 'Shooter', 'PC', 19.99, 4.5, '2015-12-01', NOW(), NOW());
